...
@section('acciones', '')
@section('breadcumb', 'Todos los Registros Suspendidos')
@section('style')
  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Todos los Registros Suspendidos</h3>
      </div>
...
@section('script')
  ...
  $(function() {
    tabla = $('#kt_datatable').DataTable({
      ...
      order: [[0, 'desc']],
      ajax: {
        url: "/registro_suspendido/tablaSuspendida",
      },
      columns: [
  ...
  function activar(id){
    ...
    $.ajax({
       ...
       url:"/registro_suspendido/Activar",
       headers: {
  ...
  $(".btn-submit_activar").click(function(e){
        ...
        console.log(id);
          $.ajax({
             ...
             url:"/registro_suspendido/activar_registro",
             headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
             },
             data:{
