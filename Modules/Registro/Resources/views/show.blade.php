...
@section('acciones', '')
@section('breadcumb')
  <a href='/registro'>Todos los Registros</a> > {{ isset($registro) ? "Ver" : "Nuevo" }}
@endsection
@section('style')
                        ...
                        <!--//////////////////////////////////////// -->
                          ...
                          <div class="row">
                              <div class="col-sm-4 col-xs-12 form-group">
                                ...
                                <div class="input-group">
                                  <p>@isset($registro){{ $registro->nombre_estructura }}@endisset</p>
                          ...
                          <div class="row">
                              <div class="col-sm-6 col-xs-12 form-group">
                                  <label>CURP </label>
                                  <p>@isset($registro){{ $registro->curp }}@endisset</p>
                              </div>
                              ...
                              <div class="col-sm-6 col-xs-12 form-group">
                                ...
                                <div class="input-group">
                                  <p>@isset($registro){{ $registro->clave_elector }}@endisset</p>
                                </div>
                              </div>
                              <div class="col-sm-4 col-xs-12 form-group">
                                  <label>Nombre </label>
                                  <p>@isset($registro){{ $registro->nombre }}@endisset</p>
                              </div>
                              <div class="col-sm-4 col-xs-12 form-group">
                                <label>Apellido Paterno</label>
                                <p>@isset($registro){{ $registro->paterno }}@endisset</p>
                              </div>
                              <div class="col-sm-4 col-xs-12 form-group">
                                <label>Apellido Materno</label>
                                <p>@isset($registro){{ $registro->materno }}@endisset</p>
                              </div>

                              <div class="col-sm-4 col-xs-12 form-group">
                                  <label>Fecha Nacimiento </label>
                                  <p>@isset($registro){{ $registro->fecha_naciminto }}@endisset</p>
                              </div>

                              <div class="col-sm-4 col-xs-12 form-group">
                                <label>Género</label>
                                <p>@isset($registro){{ $registro->genero }}@endisset</p>
                              </div>

                              <div class="col-sm-4 col-xs-12 form-group">
                                  <label>RFC</label>
                                  <p>@isset($registro){{ $registro->rfc }}@endisset</p>
                              </div>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      <div class="row">
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Calle</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->calle_domicilio }}@endisset</p>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->num_ext }}@endisset</p>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->num_int }}@endisset</p>
                            </div>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->calle_ref1 }}@endisset</p>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->cp }}@endisset</p>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Colonia</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->nombre_asentamiento }}@endisset</p>
                            </div>
                            <!--<div class="input-group">
                      ...
                      <div class="row">
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Estado</label>
                            <div class="input-group">
                              <p>{{ $registro->domicilio_entidad }}</p>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>{{ $registro->domicilio_municipio }}</p>
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->localidad }}@endisset</p>
                            </div>
                          </div>
                      </div>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      <div class="row">
                          <div class="col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->correo_electronico }}@endisset</p>
                            </div>
                          </div>
                      </div>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      <div class="row">
                          ...
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Sección</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->seccion_ine }}@endisset</p>
                            </div>
                          </div>
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Año Vigencia</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->vigencia_ine }}@endisset</p>
                            </div>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->distrito_fede_ine }}@endisset</p>
                            </div>
                          </div>
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Distrito Local</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->distrito_l_ine }}@endisset</p>
                            </div>
                          </div>
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>Domicilio</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->calle_ine }}@endisset</p>
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->num_ext_ine }}@endisset</p>
                            </div>
                          </div>
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>N° Interior</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->num_int_ine }}@endisset</p>
                            </div>
                          </div>
                          <div class="col-sm-4 col-xs-12 form-group">
                            <label>C.P</label>
                            <div class="input-group">
                              <p>@isset($registro){{ $registro->cp_ine }}@endisset</p>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-sm-4 col-xs-12 form-group">
                          <label>Colonia</label>
                          <div class="input-group">
                            <p>@isset($registro){{ $registro->colonia_ine }}@endisset</p>
