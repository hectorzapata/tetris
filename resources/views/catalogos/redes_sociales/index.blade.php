  ...
  <div class="col-md-12">
    <div class="card card-custom gutter-b">
      <div class="card-header">
              ...
              <a href="{{ route('redes_sociales.create') }}" class="btn btn-primary mr-2">Nueva Red Social</a>
        ...
        <div class="card-body">
          <table class="table table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 978px;">
            <thead>
              <tr role="row">
                  <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 72px;" aria-label="Status: activate to sort column ascending">Nombre de Red Social</th>
              ...
              <tbody>
                @foreach($redsocial_table as $redsocial)
