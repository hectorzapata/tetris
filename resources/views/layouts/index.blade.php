...
<head><base href="">
  <meta charset="utf-8"/>
  <title>Organismos | @yield('titulo', 'Yield titulo')</title>
  <meta name="description" content="Sistema de organismos"/>
  ...
  <link href="/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6" rel="stylesheet" type="text/css"/>
  ...
  <link href="/metronic/assets/css/themes/layout/aside/dark.css?v=7.0.6" rel="stylesheet" type="text/css"/>
  <!--end::Layout Themes-->
  ...
  <style media="screen">
    ...
    li.breadcrumb-item.item-active a {
      color: rgb(53,149,246) !important;
    }
  </style>
  @yield('style')
</head>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                  @yield('titulo', 'Yield titulo')
                </h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  @yield('breadcumb', 'Yield breadcumb')
                </ul>
                <!--end::Actions-->
              </div>
              <!--end::Info-->
  ...
  <script src="/metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.6"></script>
  <!--end::Page Vendors-->
  <!--begin::Page Scripts(used by this page)-->
  <script src="/metronic/assets/js/pages/widgets.js?v=7.0.6"></script>
  <!--end::Page Scripts-->
  @yield('script')
</body>
<!--end::Body-->
